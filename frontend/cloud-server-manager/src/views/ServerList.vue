  ...
  <div class="server-list">
    <el-card>
      ...
      <el-table :data="servers" v-loading="loading" stripe style="width: 100%">
        ...
        <el-table-column prop="disk" label="磁盘" min-width="120" />
        <el-table-column prop="pricePerMonth" label="月费(元)" width="100" />
    ...
    <!-- 新增/编辑弹窗 -->
    <el-dialog v-model="dialogVisible" :title="isEditing ? '修改套餐' : '新增套餐'" width="480px">
      <el-form :model="form">
        ...
        <el-form-item label="月费(元)">
          <el-input-number v-model="form.pricePerMonth" :min="0" :precision="2" style="width: 100%" />
        </el-form-item>
